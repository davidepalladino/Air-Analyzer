...
const uint8_t positionMessageInstallationTimezonePage[5] =              {0, 26, 8, 19, 30};             // x, x, y, y, y
const uint8_t positionMessageUpgradeConfigurationToVersionTwoPage[5] =  {0, 26, 8, 19, 30};             // x, x, y, y, y
const uint8_t positionMessageUpdatePage[4] =                            {0, 8, 19, 30};                 // x, y, y, y
...
const String installationTimezonePageMessages[3] =                      {"Short press to change", "Long to finish", "TIMEZONE: "};
